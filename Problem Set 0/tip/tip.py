"""
Well, we've written most of a tip calculator for you. Unfortunately, we 
didn't have time to implement two functions:
...
percentage as a float. For instance, given 15% as input, it should return 
0.15.
